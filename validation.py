...
if __name__ == "__main__":
    ...
    parser.add_argument('--finetune_path', type = str, default = '/media/ztt/6864FEA364FE72E4/lty/Grayscale2RGB-simulated-data-master/models/colorization/uresnet_noise0.050_epoch10_bs1.pth', help = 'load the pre-trained model with certain epoch, None for pre-training')
    ...
    parser.add_argument('--val_path', type = str, default = '/media/ztt/6864FEA364FE72E4/lty/results', help = 'saving path that is a folder')
    ...
    parser.add_argument('--in_path_train', type = str, \
        default = '/media/ztt/6864FEA364FE72E4/lty/train_rgb', help = 'input baseroot')
